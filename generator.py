...
# 👋 |  Hey, before you see the code Follow me! 🖤

import string as str
import secrets
import random  # This is the module to get random numbers!
...
class Run:
    ...
    def run(self):
        menu = f"""👋 | Bienvenido a Contraseña Generator
Comandos:
    Generar contraseña ->
    <Idioma de la contraseña>

Comandos para cambiar los caracteres que se utilizarán para generar contraseñas:
